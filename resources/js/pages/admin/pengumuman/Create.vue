    ...
    layout: (h: any, page: any) =>
        h(
            AdminLayout,
            {
                ...
                subTitle:
                    'Kelola konten pengumuman dan informasi penting perpustakaan',
            },
            { default: () => page },
        ),
});
...
// --- STATE ---
// Menggunakan <any> untuk menghindari error TS pada properti dinamis 'flash'
...
const handleSubmit = () => {
    form.post('/admin/pengumuman/store', {
        ...
        onSuccess: () => {
            ...
            // Tampilkan notifikasi sukses lokal
...
<template>
    <div class="relative">
            ...
            >
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm opacity-90">
                        {{
                            successMessage ||
                            'Pengumuman baru berhasil ditambahkan ke database.'
                        }}
                    </p>
                </div>
                <button
        ...
        <!-- show-attachment="true" karena pengumuman biasanya butuh lampiran dokumen -->
        <ArticleForm
            v-model="article"
