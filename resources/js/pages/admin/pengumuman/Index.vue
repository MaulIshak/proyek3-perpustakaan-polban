...
import { FileSearch, Megaphone, Plus, Search, ArrowUpDown } from 'lucide-vue-next';
    ...
    <div class="space-y-6">
        ...
        >
            ...
            >
                ...
                <Megaphone v-else-if="status !== 'all'" class="h-10 w-10 text-slate-400" />
            ...
            <h3 class="text-lg font-bold text-slate-800">
                {{
                    search
                        ...
                        : status !== 'all'
                        ? `Tidak Ada Pengumuman ${status === 'published' ? 'Published' : 'Draft'}`
            ...
            <p class="mt-1 max-w-sm text-center text-sm text-slate-500">
                {{
                    search
                        ...
                        : status !== 'all'
                        ? `Tidak ada pengumuman dengan status ${status === 'published' ? 'published' : 'draft'}.`
