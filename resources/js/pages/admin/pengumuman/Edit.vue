...
const articleData = ref({
    ...
    // Thumbnail & Attachment: null untuk file baru, url_xxx untuk preview lama
    thumbnail: null as File | null,
    url_thumbnail: props.article.url_thumbnail || null,
    attachment: null as File | null,
    // Note: ArticleForm mungkin perlu disesuaikan jika ingin menampilkan nama file lama untuk attachment,
    // tapi di sini kita simpan referensinya.
...
// Form Inertia
const form = useForm({
    _method: 'PUT', // Spoofing method PUT untuk upload file
...
const handleSubmit = () => {
    form.post(`/admin/pengumuman/update/${props.article.article_id}`, {
        ...
        onSuccess: () => {
            ...
            // Tidak perlu reset form agar user tetap bisa melihat data yang diedit
        },
        onError: (errors) => {
...
<template>
    <div class="relative">
        ...
        <!-- show-attachment="true" karena pengumuman bisa punya lampiran -->
        <ArticleForm
            v-model="articleData"
