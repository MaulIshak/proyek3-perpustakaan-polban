...
import ScrollReveal from '@/components/ScrollReveal.vue'; // Import Component
    ...
    <Layout :page="true" :breadcrumb="breadcrumb" title="E-Collection">
        ...
        <div class="relative container mx-auto py-8">
            <ScrollReveal
                animation="fade-up"
                :duration="500"
                class="mx-auto overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-xl shadow-slate-200/60"
            >
                <div
                    class="h-2 w-full bg-gradient-to-r from-lime-400 to-[var(--dark-green)]"
                ></div>

                <div class="p-8 md:p-10">

                    <ScrollReveal animation="fade-up" :delay="100" class="mb-8 flex items-center gap-4">
                    ...
                    <div class="grid grid-cols-1 gap-10 lg:grid-cols-12">
                        ...
                        <div class="space-y-8 lg:col-span-8">
                            ...
                            <ScrollReveal animation="fade-up" :delay="100" class="prose max-w-none prose-slate">
                                <p
                            ...
                            <div>
                                ...
                                >
                                    <ScrollReveal animation="fade-up" :delay="100" class="h-full">
                                        <div
                                            class="group relative flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-gradient-to-b from-white to-emerald-50/30 p-5 transition hover:border-emerald-400 hover:shadow-lg hover:shadow-emerald-100/50 h-full"
                                        >
                                            <div
                                    ...
                                    <ScrollReveal animation="fade-up" :delay="100" class="h-full">
                                        <div
                                            class="group relative flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-gradient-to-b from-white to-sky-50/30 p-5 transition hover:border-sky-400 hover:shadow-lg hover:shadow-sky-100/50 h-full"
                                        >
                                            <div
                                                class="absolute top-0 right-0 translate-x-2 -translate-y-2 transform p-3 opacity-10 transition-opacity group-hover:opacity-20"
                                            >
                                    ...
                                    <ScrollReveal animation="fade-up" :delay="100" class="md:col-span-2">
                                        <div
                                            class="group relative flex flex-col items-center gap-4 overflow-hidden rounded-xl border border-slate-200 bg-gradient-to-r from-white to-purple-50/50 p-5 transition hover:border-purple-400 hover:shadow-lg hover:shadow-purple-100/50 sm:flex-row"
                                        >
                                            <div
