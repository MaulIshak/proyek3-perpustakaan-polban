        ...
        <div class="relative container mx-auto px-4 py-10 sm:px-6 lg:px-8">
            ...
            >
                <div
                    ...
                    :key="item.id_team"
                    class="group relative flex flex-col items-center rounded-2xl border border-slate-100 bg-white p-8 text-center shadow-lg shadow-slate-200/60 transition-all duration-300 hover:-translate-y-1 hover:border-[#99cc33]/30"
                >
                    ...
                    <!-- Jabatan -->
                    <div
                        class="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-100 bg-slate-50 px-4 py-2 text-slate-600 transition-all group-hover:border-[#99cc33]/10 group-hover:bg-[#99cc33]/5"
                    >
                        <Briefcase class="h-4 w-4 shrink-0 text-[#99cc33]" />
