    ...
    <Layout :page="true" :title="title" :breadcrumb="breadcrumb">
        ...
        <div class="relative container mx-auto px-4 py-10 sm:px-6 lg:px-8">
            <div
                ...
                class="flex flex-wrap justify-center gap-6 lg:gap-8"
            >
                <ScrollReveal
                    ...
                    animation="fade-up"
                    :delay="index * 100"
                    class="w-full max-w-[340px] shrink-0"
                >
                    <div
                        class="group relative flex h-full flex-col items-center rounded-2xl border border-slate-100 bg-white p-8 text-center shadow-lg shadow-slate-200/60 transition-all duration-300 hover:-translate-y-1 hover:border-[#99cc33]/30 hover:shadow-xl hover:shadow-[#99cc33]/10"
                    >
                        <div
