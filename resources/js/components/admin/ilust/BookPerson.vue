    ...
    >
        <g transform="translate(-583 -242.762)">
            <path
                ...
                transform="translate(583 248.082)"
                fill="#d6d6e3"
            />
            <path
                ...
                transform="translate(159.926 200.319)"
                fill="#ed9da0"
            />
            <ellipse
                cx="55.446"
                ...
                rx="55.446"
                ry="55.446"
                transform="translate(744.23 275.186)"
                fill="#ed9da0"
            />
            <path
                ...
                transform="translate(492.433 242.766)"
                fill="#090814"
            />
            <g transform="translate(1039.462 678.195)">
                ...
                />
                <path
                    d="M59.16,583.339,168.589,563.39l145,23.1-90.061,32.424Z"
                ...
                <rect
                    width="41.309"
                    height="0.437"
                    transform="translate(163.638 162.397) rotate(-18.45)"
                    opacity="0.1"
                />
                <rect
                    width="50.333"
                    height="0.437"
                    transform="translate(163.623 165.914) rotate(-20.82)"
                    opacity="0.1"
                />
                <rect
                    width="58.34"
                    height="0.437"
                    transform="translate(163.886 170.06) rotate(-22.26)"
                    opacity="0.1"
                />
                <rect
                    width="67.155"
                    height="0.437"
                    transform="translate(164.516 173.715) rotate(-24.31)"
                    opacity="0.1"
                />
                <rect
                    width="73.449"
                ...
                <rect
                    width="87.895"
                    height="0.437"
                    transform="translate(166.018 178.481) rotate(-23.36)"
                    opacity="0.1"
                />
                <path
                    d="M614.074,659.69s3.975,1.6,1.642,4.08S524,692.114,524,692.114Z"
                ...
                />
                <path
                    d="M158.46,487.155,267.885,467.21l145,23.1-90.061,32.424Z"
                ...
                />
                <path
                    d="M600.094,646.68s-8.736,10.483,0,26.209"
                ...
                <rect
                    width="41.309"
                    height="0.437"
                    transform="translate(207.012 120.39) rotate(-18.45)"
                    opacity="0.1"
                />
                <rect
                    width="50.333"
                    height="0.437"
                    transform="translate(207.003 123.905) rotate(-20.82)"
                    opacity="0.1"
                />
                <rect
                    width="58.34"
                    height="0.437"
                    transform="translate(207.26 128.044) rotate(-22.26)"
                    opacity="0.1"
                />
                <rect
                    width="67.155"
                    height="0.437"
                    transform="translate(207.895 131.7) rotate(-24.31)"
                    opacity="0.1"
                />
                <rect
                    width="73.449"
                ...
                <rect
                    width="87.895"
                    height="0.437"
                    transform="translate(209.393 136.461) rotate(-23.36)"
                    opacity="0.1"
                />
                <path
                    d="M713.391,563.51s3.971,1.6,1.642,4.076-91.7,28.344-91.7,28.344Z"
                ...
                />
                <path
                    d="M167.89,377.129,277.319,357.18l145,23.1L332.257,412.7Z"
                ...
                <rect
                    width="41.309"
                    height="0.437"
                    transform="translate(211.136 72.327) rotate(-18.45)"
                    opacity="0.1"
                />
                <rect
                    width="50.333"
                    height="0.437"
                    transform="translate(211.125 75.844) rotate(-20.82)"
                    opacity="0.1"
                />
                <rect
                    width="58.34"
                    height="0.437"
                    transform="translate(211.377 79.986) rotate(-22.26)"
                    opacity="0.1"
                />
                <rect
                    width="67.155"
                    height="0.437"
                    transform="translate(212.018 83.638) rotate(-24.31)"
                    opacity="0.1"
                />
                <rect
                    width="73.449"
                ...
                <rect
                    width="87.895"
                    height="0.437"
                    transform="translate(213.517 88.405) rotate(-23.36)"
                    opacity="0.1"
                />
                <path
                    d="M722.821,453.48s3.975,1.6,1.642,4.08-91.7,28.344-91.7,28.344Z"
                    transform="translate(-416.78 -430.382)"
                    fill="#99cc33"
                />
                <path
                    d="M712.45,427s-15.581,2.359-18.49,5.561"
                    transform="translate(-451.247 -415.468)"
                    opacity="0.1"
                />
                <path
                    d="M650.52,452.263a33.44,33.44,0,0,1,5.015-3.114,81.812,81.812,0,0,0,7.426-4.538"
            ...
            <path
                ...
                transform="translate(198.203 221.815)"
                fill="#ed9da0"
            />
            <path
                ...
                transform="translate(159.526 222.237)"
                fill="#ed9da0"
            />
            <path
                ...
                transform="translate(165.953 260.755)"
                fill="#090814"
            />
            <path
                ...
                transform="translate(159.526 213.314)"
                opacity="0.1"
            />
            <path
                ...
                transform="translate(159.526 213.073)"
                fill="#d6d6e3"
            />
            <path
                ...
                transform="translate(165.674 211.627)"
                fill="#d6d6e3"
            />
            <path
                d="M581.79,499.507l49.221,1.576-7.06-36.5-37.707,3.586Z"
                transform="translate(282.865 329.357)"
                fill="#ed9da0"
            />
            <path
                ...
                transform="translate(179.499 261.003)"
                fill="#090814"
            />
            <path
                ...
                transform="translate(161.442 280.982)"
                fill="#090814"
            />
            <path
                ...
                transform="translate(179.497 277.072)"
                opacity="0.1"
            />
            <path
                ...
                transform="translate(146.215 261.359)"
                fill="#090814"
            />
            <path
                d="M536.27,427.513a23.7,23.7,0,0,1,20.336,5.372c9.926,8.276,43.327,24.89,43.327,24.89"
                transform="translate(161.999 266.444)"
                opacity="0.1"
            />
            <path
                d="M746.481,427s-44.258,6.7-52.521,15.795"
                transform="translate(199.964 266.436)"
                opacity="0.1"
            />
            <path
                ...
                transform="translate(197.955 280.982)"
                fill="#090814"
            />
            <path
                ...
                transform="translate(161.4 218.208)"
                fill="#f2f2f2"
            />
            <path
                d="M437.38,202.83,447.1,319.052l102.983,5.174L545.612,208.5l-.087-1.948Z"
                transform="translate(248.096 266.338)"
                fill="#99cc33"
            />
            <path
                d="M655.944,200.83,549.71,216.761V333.5l103.814-15Z"
                transform="translate(275.141 265.857)"
                fill="#99cc33"
            />
            <path
                d="M626.275,223.79l-57.385,6.378,1.253,19.554,56.095-6.129Z"
                transform="translate(279.758 271.385)"
                fill="#fff"
                opacity="0.3"
            />
            <path
            ...
            />
            <path
                d="M640.29,248.808s43.216-13.214,54.482-11.353"
                transform="translate(187.041 220.758)"
                opacity="0.1"
            />
            <path
                d="M610.816,243.4s-41.888-9.926-48.886-7.11"
                transform="translate(168.177 220.398)"
                opacity="0.1"
            />
            <path
                d="M662.25,249.242s28.9-10.6,39.345-5.559"
                transform="translate(192.328 221.973)"
                opacity="0.1"
            />
            <path
                d="M650.52,466.348a95,95,0,0,1,14.244-8.847c7.444-3.586,21.093-12.891,21.093-12.891"
                transform="translate(189.505 270.675)"
                opacity="0.1"
            />
            <path
                d="M568.214,360.08s-18.128,14.827-23.574,16.13-8.809,12.867-8.809,12.867"
                transform="translate(161.891 250.324)"
                opacity="0.1"
            />
            <path
                ...
                transform="translate(189.93 237.041)"
                fill="#ed9da0"
            />
            <path
                d="M691.69,358.3s15.97,13,20.783,14.144,7.766,11.282,7.766,11.282"
                transform="translate(203.25 253.466)"
                opacity="0.1"
            />
        </g>
    </svg>
